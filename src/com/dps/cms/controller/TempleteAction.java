...
public class TempleteAction extends BaseAction {
	...
	public View list(@Param("currentPage") int currentPage, String type, HttpServletRequest req) {
		...
		if (type != null && !"".equals(type)) {
			...
			result = basicDao.searchByPage(	Templete.class,
											Cnd.where("type", "=", t).desc("createDate"),
											currentPage,
											SystemContext.PAGE_SIZE);
			count = basicDao.searchCount(Templete.class, Cnd.where("type", "=", t));
		} else {
			result = basicDao.searchByPage(	Templete.class,
											currentPage,
											SystemContext.PAGE_SIZE,
	...
	public String delByIds(	@Param("ids") String ids,
		...
		List<Templete> templates = basicDao.searchByIds(Templete.class, ids, "id");
